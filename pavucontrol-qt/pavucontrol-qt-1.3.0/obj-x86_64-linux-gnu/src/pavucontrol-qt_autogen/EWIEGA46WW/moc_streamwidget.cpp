/****************************************************************************
** Meta object code from reading C++ file 'streamwidget.h'
**
...
#include <memory>
#include "../../../../src/streamwidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'streamwidget.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject StreamWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<MinimalStreamWidget::staticMetaObject>(),
    qt_meta_stringdata_StreamWidget.data,
    qt_meta_data_StreamWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *StreamWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::StreamWidget"))
        return static_cast< Ui::StreamWidget*>(this);
