...
QT_INIT_METAOBJECT const QMetaObject SourceWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<DeviceWidget::staticMetaObject>(),
    qt_meta_stringdata_SourceWidget.data,
    qt_meta_data_SourceWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
