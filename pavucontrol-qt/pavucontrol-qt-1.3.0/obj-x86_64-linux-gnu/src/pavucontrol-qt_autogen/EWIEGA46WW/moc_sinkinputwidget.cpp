...
QT_INIT_METAOBJECT const QMetaObject SinkInputWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<StreamWidget::staticMetaObject>(),
    qt_meta_stringdata_SinkInputWidget.data,
    qt_meta_data_SinkInputWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
