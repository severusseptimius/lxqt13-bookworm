...
QT_MOC_LITERAL(1, 14, 15), // "restoreSettings"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 18), // "updateNotification"
QT_MOC_LITERAL(4, 50, 19) // "previewNotification"

    },
    "BasicSettings\0restoreSettings\0\0"
    "updateNotification\0previewNotification"
};
...
void BasicSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->restoreSettings(); break;
        case 1: _t->updateNotification(); break;
        case 2: _t->previewNotification(); break;
        default: ;
        }
    }
    (void)_a;
...
void *BasicSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::BasicSettings"))
        return static_cast< Ui::BasicSettings*>(this);
