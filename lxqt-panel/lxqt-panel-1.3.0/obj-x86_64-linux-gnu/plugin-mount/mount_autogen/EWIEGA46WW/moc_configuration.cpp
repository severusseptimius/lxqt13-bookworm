...
#include <memory>
#include "../../../../plugin-mount/configuration.h"
...
QT_MOC_LITERAL(5, 50, 19) // "ejectPressedChanged"

    },
    "Configuration\0loadSettings\0\0devAddedChanged\0"
    "index\0ejectPressedChanged"
};
...
void Configuration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->ejectPressedChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
