...
#include <memory>
#include "../../../../plugin-backlight/sliderdialog.h"
...
QT_MOC_LITERAL(1, 13, 12), // "dialogClosed"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 18), // "sliderValueChanged"
QT_MOC_LITERAL(4, 46, 5), // "value"
QT_MOC_LITERAL(5, 52, 17), // "downButtonClicked"
QT_MOC_LITERAL(6, 70, 15) // "upButtonClicked"

    },
    "SliderDialog\0dialogClosed\0\0"
    "sliderValueChanged\0value\0downButtonClicked\0"
    "upButtonClicked"
};
...
void SliderDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->downButtonClicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->upButtonClicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SliderDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SliderDialog::dialogClosed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SliderDialog::dialogClosed()
{
