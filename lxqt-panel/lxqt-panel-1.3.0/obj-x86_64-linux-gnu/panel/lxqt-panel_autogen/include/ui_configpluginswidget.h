...
public:
    ...
    {
        ConfigPluginsWidget->setWindowTitle(QCoreApplication::translate("ConfigPluginsWidget", "Configure Plugins", nullptr));
        label->setText(QCoreApplication::translate("ConfigPluginsWidget", "Note: changes made in this page cannot be reset.", nullptr));
#if QT_CONFIG(tooltip)
        pushButton_moveUp->setToolTip(QCoreApplication::translate("ConfigPluginsWidget", "Move up", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_moveUp->setText(QCoreApplication::translate("ConfigPluginsWidget", "...", nullptr));
#if QT_CONFIG(tooltip)
        pushButton_moveDown->setToolTip(QCoreApplication::translate("ConfigPluginsWidget", "Move down", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_moveDown->setText(QCoreApplication::translate("ConfigPluginsWidget", "...", nullptr));
#if QT_CONFIG(tooltip)
        pushButton_addPlugin->setToolTip(QCoreApplication::translate("ConfigPluginsWidget", "Add", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_addPlugin->setText(QCoreApplication::translate("ConfigPluginsWidget", "...", nullptr));
#if QT_CONFIG(tooltip)
        pushButton_removePlugin->setToolTip(QCoreApplication::translate("ConfigPluginsWidget", "Remove", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_removePlugin->setText(QCoreApplication::translate("ConfigPluginsWidget", "...", nullptr));
#if QT_CONFIG(tooltip)
        pushButton_pluginConfig->setToolTip(QCoreApplication::translate("ConfigPluginsWidget", "Configure", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton_pluginConfig->setText(QCoreApplication::translate("ConfigPluginsWidget", "...", nullptr));
    } // retranslateUi
