...
QT_MOC_LITERAL(4, 35, 14) // "receiveMessage"

    },
    "SingleApp\0messageReceived\0\0message\0"
    "receiveMessage"
};
...
void SingleApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SingleApp *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SingleApp::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SingleApp::messageReceived)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SingleApp::staticMetaObject = { {
    QMetaObject::SuperData::link<QApplication::staticMetaObject>(),
    qt_meta_stringdata_SingleApp.data,
    qt_meta_data_SingleApp,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void SingleApp::messageReceived(const QString & _t1)
{
